...
Link to the original data source: https://catalog.data.gov/dataset/nypd-arrest-data-year-to-date
The dataset can be found from data.gov and we used the csv file under the link above. 
...
Data cleaning:
Link to cleaned data file: https://github.com/sussmanbu/ma4615-sp25-final-project-team-6/blob/main/dataset/cleaned_dataset.rds
